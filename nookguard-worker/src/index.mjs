...
// content-hash check) lives in src/router.mjs / src/db.mjs /
// src/enforce.mjs / src/artifacts.mjs, which are plain, dependency-
// injected functions tested directly in tests/ against real SQLite
// (tests/fakeD1.mjs) and a real-enough in-memory R2 shim
// (tests/fakeR2.mjs). This file is the only piece of code in this package
...
export default {
  async fetch(request, env) {
    return routeRequest(request, { db: env.DB, artifacts: env.ARTIFACTS });
  },
};
