...
category: "Desk fixes"
image: "/winnie/winnie-guide-footrest-checkin.jpg"
...
<figure class="inline-photo">
  ...
  <figcaption>The angle is what actually relieves the pressure point.</figcaption>
</figure>
...
<figure class="inline-photo">
  ...
  <figcaption>Chair height alone is a two-variable problem — this is the third variable.</figcaption>
</figure>
...
I ran a library reference desk for ten years before any of this, and the number-one thing that job teaches you is that people usually ask for the wrong fix first, not because they're wrong to want relief, but because the actual mechanism isn't obvious until someone explains it. Nobody comes to a desk asking "how do I stop compressing the popliteal area behind my knee" — they ask how to make their chair more comfortable, which sends them chasing the wrong dial. My whole job back then, and honestly my whole job now, was translating the question someone actually has into the question that gets them an answer that works. The desk changed. The translating didn't.
...
<figure class="inline-photo">
  ...
  <figcaption>The lever gets blamed. The footrest is the actual fix.</figcaption>
</figure>
...
<figure class="inline-photo">
  ...
  <figcaption>Tucked underneath, doing its one job quietly.</figcaption>
</figure>
...
<figure class="inline-photo">
  ...
  <figcaption>Three to five days is the usual timeline reviewers report.</figcaption>
</figure>
