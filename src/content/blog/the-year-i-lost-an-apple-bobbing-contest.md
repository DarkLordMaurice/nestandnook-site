...
image: "/winnie/winnie-life-halloween-apple-bobbing.jpg"
winniePhoto: "/winnie/headshot-v4-1.jpg"
relatedGuides:
  - label: "What a Día de Muertos Parade Actually Taught Me"
...
<div class="photo-strip">
  ...
  <figure class="polaroid">
    <img src="/winnie/the-year-i-lost-an-apple-bobbing-contest-nonwinnie-scene8-skeleton-wine-pour.jpg" alt="A plastic skeleton Halloween party prop posed pouring wine into a glass at a candlelit drinks table" width="1024" height="1024" />
  </figure>
  <figure class="polaroid">
    <img src="/winnie/the-year-i-lost-an-apple-bobbing-contest-nonwinnie-scene9-facepaint-supplies.jpg" alt="Sugar-skull face-paint supplies laid out on the floor: an open palette, makeup brushes, and a hand mirror" width="1024" height="1024" />
  </figure>
</div>

## The makeup was a whole production, and I'd do it again

The face paint took longer than getting genuinely ready for anything else I've done this year — a heart, a filigree line down each cheek, the works, applied with a level of care I usually reserve for cross-referencing a spec sheet. I'll say plainly that the sugar-skull style borrows from a tradition I only really came to understand properly at a Día de Muertos parade later that same week, and looking back, I'd probably think a little harder about wearing it as a costume now that I know more. Worth reading if you haven't — it's a genuinely different thing from a party look, and the gap between the two is bigger than I appreciated going in. I don't think there's anything to do about that after the fact except say so plainly, which I'd rather do than pretend the timing worked out more thoughtfully than it did.
