...
products:
  ...
  - name: "Kensington SoleMate Plus (SmartFit System)"
    ...
    pros:
      ...
      - "Angle adjusts up to ~30° for circulation"
    cons:
      - "Costs more than the wood-and-foam options"
  ...
  - name: "StrongTek Wooden 3-Height Footrest"
    ...
    pros:
      ...
      - "Durable natural wood, easy to wipe down"
    cons:
      - "Hard surface with no cushion"
  ...
  - name: "StrongTek 4-Angle Wooden Footrest"
    ...
    pros:
      ...
      - "Simple, tough wood build with easy assembly"
      - "Wallet-friendly entry point"
    cons:
...
|----------|----------|------|---------|------|
| HUANUO Ergonomic | Overall / short users | Highest (to ~6.7") | Cushioned, textured | Yes + rocks |
| Kensington SoleMate Plus | Precise control | Fine-adjust | Anti-skid | Up to ~30° |
