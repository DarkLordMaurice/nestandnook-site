---
title: "The Ergonomic Desk Setup Checklist (2026)"
description: "An ergonomic desk setup checklist covering the five fixes that actually matter, in the order to tackle them, before you spend money on anything else."
primaryKeyword: "ergonomic desk setup"
hub: "home-office"
pageType: "how_to"
...
faqs:
  - q: "What's the very first thing to fix in an ergonomic desk setup?"
    a: "Chair height relative to the desk, before anything else — it determines your wrist angle and, indirectly, whether your feet reach the floor. Every other fix on this checklist assumes that base relationship is already correct."
  - q: "Can I do this whole checklist without spending money?"
    a: "Parts of it, yes — chair height, elbow position, and monitor distance are all free adjustments. The two most common paid fixes are a footrest (if your feet don't reach the floor) and a monitor stand or riser (if your screen sits too low), and both are inexpensive relative to the strain they solve."
