...
ingredientGroups:
  - groupName: "For the panade (the moisture trick)"
    items:
      - "3 slices white sandwich bread, torn into small pieces (or 3/4 cup plain breadcrumbs)"
      - "1/2 cup whole milk"
  - groupName: "For the meatloaf"
    items:
      - "2 lbs ground beef (80/20 works best — leaner cuts dry out faster)"
      - "1 small yellow onion, finely diced"
      - "2 cloves garlic, minced"
      - "2 large eggs, beaten"
      - "1/4 cup grated Parmesan (optional, adds savoriness)"
